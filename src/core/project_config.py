...
class ProjectConfig:
    ...
    def get_pipeline_providers(self) -> dict[str, dict[str, Any]]:
        """Get all configured pipeline providers for this project."""
        return cast(
            "dict[str, dict[str, Any]]",
            self._base_config.get_value(f"{self._project_key}.pipelines", {}),
        )
